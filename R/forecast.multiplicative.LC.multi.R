...
#'
#' @param fitted.obj object developed using function fit.mutliplicative.LC.multi()
...
#' \code{\link{forecast.additive.LC.multi}}, \code{\link{multipopulation_cv}},
#'
#' @references
#'
...
#'
#' fut_multiplicative_Spainmales <- forecast.multiplicative.LC.multi(fitted.obj = additive_Spainmales, nahead = 10,
...
forecast.multiplicative.LC.multi <- function(fitted.obj, nahead,
  ...
  if(!is.list(fitted.obj)){
    stop("The fitted.obj is not a list. Use 'fit.mutiplicative.LC.multi' function first")
  }
